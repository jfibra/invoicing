...
export async function POST(request: NextRequest) {
  try {
    ...
    // Save strictly under commissions_hub/sales/ folder in S3 bucket
    // Path format: commissions_hub/sales/{FILE_CATEGORY}/{timestamp}_{random}_{filename}
    const s3Key = `commissions_hub/sales/${fileCategoryCode}/${timestamp}_${randomStr}_${cleanFileName}`;
    ...
    console.error("S3 Sales Attachment Upload Error:", error);
